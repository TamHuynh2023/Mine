import { addPost, cancelEditPost, finishEditingPost } from 'blog/blog.slice'
...
export default function CreatePost() {
    ...
    useEffect(() => {
        setFormData(editPost || initialData)
    }, [editPost])
    ...
    function cancelEdit() {
        dispatch(cancelEditPost(formData))
    }

    return (
        <form onSubmit={handleSubmitForm} onReset={cancelEdit}>
            <div>
                <div className='mb-6'>
