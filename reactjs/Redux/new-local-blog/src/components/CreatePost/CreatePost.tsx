...
import { addPost, cancelEditPost, updatePost } from 'blog/blog.slice'
...
export default function CreatePost() {
    ...
    const [errorForm, setErrorFrom] = useState<ErrorForm | null>(null)
        ...
        <form onSubmit={handleSubmit} onReset={handleCancel}>
            ...
            <div className='mb-6'>
                ...
                <input
                    type='datetime-local'
                    id='publishDate'
                    className={`block w-56 rounded-lg border p-2.5 text-sm focus:outline-none focus:ring-blue-500 ${errorForm?.publishDate ? 'border-red-500 bg-red-50 text-red-900 placeholder-red-700 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 bg-gray-50 text-gray-900 focus:border-blue-500 focus:ring-blue-500'}`}
                    placeholder='Title'
                    required
                ...
                {errorForm?.publishDate && (
                    <p className='mt-2 text-sm text-red-600'>
                        <span className='font-medium'>loi {errorForm.publishDate}</span>
                    </p>
                )}
            </div>
